...
#include "Impetus/Public/MyPlayer.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeMyPlayer() {}

// Begin Cross Module References
ENGINE_API UClass* Z_Construct_UClass_ACharacter();
IMPETUS_API UClass* Z_Construct_UClass_AMyPlayer();
IMPETUS_API UClass* Z_Construct_UClass_AMyPlayer_NoRegister();
UPackage* Z_Construct_UPackage__Script_Impetus();
...
UObject* (*const Z_Construct_UClass_AMyPlayer_Statics::DependentSingletons[])() = {
	...
	(UObject* (*)())Z_Construct_UPackage__Script_Impetus,
};
...
template<> IMPETUS_API UClass* StaticClass<AMyPlayer>()
{
	return AMyPlayer::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Impetus_Source_Impetus_Public_MyPlayer_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AMyPlayer, AMyPlayer::StaticClass, TEXT("AMyPlayer"), &Z_Registration_Info_UClass_AMyPlayer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMyPlayer), 2030179392U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Impetus_Source_Impetus_Public_MyPlayer_h_2613750218(TEXT("/Script/Impetus"),
	Z_CompiledInDeferFile_FID_Impetus_Source_Impetus_Public_MyPlayer_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Impetus_Source_Impetus_Public_MyPlayer_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
